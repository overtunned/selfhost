...
echo "************************************************************************"
uservar=overtunned
passvar=Abhi@1997.coM
passvar2=Abhi@1997.coM
ippms=127.0.0.1
echo 'plex.tv Username:' $uservar
echo ''
echo -p 'plex.tv Password: ' $passvar
echo ''
echo -p 'plex.tv Password Repeated:' $passvar2
echo ''
echo -p 'IP Address of PMS server: ' $ippms
